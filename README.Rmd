...
[![](http://cranlogs.r-pkg.org/badges/striprtf)](http://cran.rstudio.com/web/packages/striprtf/index.html)
...
This package implements the algorithm suggested in a stack overflow thread
